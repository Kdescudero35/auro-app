...
import { calculateDosage } from '@features/calculators/utils/calculations';
...
export function DosageResult({
  ...
  const handleAdd = (): void => {
    addItem({
      ...
      especialidad: 'Pollo De Engorde',
      categoria: 'pollo-engorde',
